...
class ItemTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        for i in userArray {
            ...
            dates.append(item.reportingDate)
            amounts.append(item.amount)
            numberOfPerson.append(item.numberOfPerson)
            selectedBank.append(item.selectedBank ?? "")
            accountHolder.append(item.accountHolder ?? "")
            accountNo.append(item.accountNumber ?? "")
        }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(String(numberOfPerson[indexPath.row]))
